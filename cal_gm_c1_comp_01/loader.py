...
TASK_IDS = ("c1comp_initial_conflict_001", "c1comp_final_free_001", "c1comp_reallocate_001")
...
def final_conflict_free(task: dict[str, Any], variant: str) -> bool:
    plan = task["final"][variant]
    return plan["agent_a"] != plan["agent_b"]
