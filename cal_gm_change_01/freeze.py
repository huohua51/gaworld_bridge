...
def build_manifest() -> dict:
    ...
    return {
        ...
        "runner_hash": _sha_files([ROOT / "run_matrix.py", ROOT / "loop.py", ROOT / "prompts.py", ROOT / "contract.py"]),
        "base_commit": commit,
        "model": "GLM-4-Flash",
        "temperature": 0,
        "do_not_edit_after_freeze": ["task_card.yaml", "tasks/", "oracle/", "protocol.md", "scorer.py", "prompts.py", "contract.py"],
    }
