...
from exp_gm_l1_01.loader import BANNED, leak_tokens_for, load_tasks, worker_private
from exp_gm_l1_01.loop import ORACLE_MARKERS
from exp_gm_l1_01.prompts import checkpoint_prompt, coordinator_prompt, direct_prompt, resume_prompt, step1_prompt, successor_step_prompt
...
def preflight() -> dict[str, Any]:
    ...
    for task in load_tasks():
        ...
        if remaining in s1 and task["id"] != "l1_01_specimen_log_001":
            pass
