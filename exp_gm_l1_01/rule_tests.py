#!/usr/bin/env python3
"""Rule calibration for EXP-GM-L1-01. Must pass before GLM."""
...
from exp_gm_l1_01.loader import BANNED, load_tasks, resume_step_for, solve_outputs
...
def test_not_old_items():
    ...
    assert ids == {"l1_01_inventory_lots_001", "l1_01_centrifuge_rotor_001", "l1_01_specimen_log_001"}
...
def main() -> int:
    ...
    test_fairness()
    print("fairness pass")
    print("EXP-GM-L1-01 Rule calibration passed.")
    return 0
