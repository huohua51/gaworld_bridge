...
from exp_gm_l1_01.contract import CHECKPOINT_VERSION, EXTRACTABLE_STEP_ERRORS
from exp_gm_l1_01.loader import oracle_plan, solve_outputs
...
def score_cell(
    *,
    ...
    if track == "direct":
        if not r0:
            err = "none"
        elif loop.get("direct_error") != "ok" or not complete:
    ...
    cell = compose(
        ...
        extra={
            ...
            "ranking_note": "L1-01 interruption recovery, not a leaderboard",
        },
    )
