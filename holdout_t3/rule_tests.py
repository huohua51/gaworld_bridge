#!/usr/bin/env python3
"""Rule calibration for HO-GM-T3-01. Must pass before GLM."""
...
from holdout_t3.prompts import reviewer_prompt, rule_builder_draft, rule_executor, rule_review
...
def _fork(tmp: Path, task: dict, variant: str):
    ...
    for track, drop, private_visible in TRACKS:
        ...
        cell = score_cell(
            ...
            workflow_id="holdout_t3_rule", instance_id=f"{task['id']}_{variant}_{track}",
...
def test_not_t3_01_items():
    ...
    assert ids == {"t3_ho_queue_max_001", "t3_ho_battery_pct_001", "t3_ho_noise_db_001"}
    banned = (
        "t3_free_ship_kg_001",
...
def main() -> int:
    ...
    print("HO-GM-T3-01 Rule calibration passed.")
    return 0
