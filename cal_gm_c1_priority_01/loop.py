...
from cal_gm_c1_priority_01.contract import action_contract, parse_json_object
from cal_gm_c1_priority_01.loader import feasible_map, initial_assignments
from cal_gm_c1_priority_01.prompts import agent_prompt
...
def run_cell(
    *,
    ...
    nack_blob = json.dumps((propose or {}).get("violations") or [])
    inspect_blob = json.dumps(inspect)
    leaked = repair_slot in nack_blob or "suggested_slot" in inspect_blob or "suggested_slot" in nack_blob
    return {
