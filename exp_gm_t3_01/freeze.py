"""Write the pre-seed0 freeze manifest. Do not edit hashed files after this."""
...
from exp_gm_t3_01.fairness import preflight
    ...
    return {
        ...
        "runner_hash": _sha_files(
            [
                ...
                ROOT / "loop.py",
                ROOT / "roles.py",
                ROOT / "contracts" / "review_action.py",
                ROOT / "fairness.py",
            ]
        ),
