#!/usr/bin/env python3
"""CAL-GM-C1-PRIORITY-02: priority preservation component calibration."""
...
from cal_gm_c1_priority_02.freeze import write_manifest
from cal_gm_c1_priority_02.loader import VARIANTS, load_tasks
from cal_gm_c1_priority_02.loop import run_cell
from cal_gm_c1_priority_02.prompts import rule_agent
from cal_gm_c1_priority_02.rule_tests import main as rule_main
...
WORKFLOW_ID = "cal_gm_c1_priority_02"
...
def main() -> int:
    ...
    if args.phase == "rule":
        ...
        return 0
    out = BRIDGE_ROOT / "output" / "cal_gm_c1_priority_02_20260825"
