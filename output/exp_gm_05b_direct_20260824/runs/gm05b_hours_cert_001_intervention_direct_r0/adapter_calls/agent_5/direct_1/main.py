...
if __name__ == "__main__":
    # Example usage
    print(can_work(certified=True, hours=30))  # Should print True
    print(can_work(certified=False, hours=30)) # Should print False
    print(can_work(certified=True, hours=36))  # Should print False
