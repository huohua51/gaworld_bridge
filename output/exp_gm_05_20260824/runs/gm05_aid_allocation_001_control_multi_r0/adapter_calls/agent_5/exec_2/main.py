...
if __name__ == "__main__":
    ...
    applicants = [
        ...
        {'name': 'Charlie', 'age': 30, 'income': 30000, 'priority': 'critical', 'budget_request': 8000},
        {'name': 'David', 'age': 22, 'income': 45000, 'priority': 'high', 'budget_request': 4000},
        {'name': 'Eve', 'age': 45, 'income': 50000, 'priority': 'standard', 'budget_request': 2000},
    ]
